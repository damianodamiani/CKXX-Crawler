...
def crawl_articles(beginDate, endDate, destdir):
    ...
    for date_str in data:
        ...
        dataurl = f'https://www.laoziliao.net/ckxx/{year}-{month}-{day}'
...
if __name__ == '__main__':
    ...
    endDate = 'YYYY-MM-DD'  # Replace 'YYYY-MM-DDD' with the desired start date.
    destdir = '/path/to/output/directory'  # Set 'destdir' to the desired directory path where you want the files to be saved.
